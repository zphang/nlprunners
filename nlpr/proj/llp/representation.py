...
def compute_global_agg_loss(embedding, label_id, big_m_tensor, all_labels_tensor, const_tau):
    ...
    selector = F.one_hot(all_labels_tensor).t()[label_id].float()
...
def compute_global_agg_loss_v2(embedding, label_id, big_m_tensor, all_labels_tensor,
